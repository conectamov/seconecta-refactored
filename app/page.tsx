...
export default function LandingPage() {
  ...
  return <main className="landing-page">
    ...
    <section className="tl-section" id="oportunidades"><div className="tl-container">
      <Reveal className="tl-heading tl-heading-row"><div><span className="tl-label">Oportunidades em destaque</span><h2>Seu próximo passo pode estar aqui.</h2><p>Programas selecionados para estudantes que querem aprender, criar e ir além.</p></div><a href="#">Explorar todas <span>›</span></a></Reveal>
      ...
      <Reveal className="tl-personalized-cta"><span className="tl-personalized-icon"><Sparkles size={18} /></span><div><strong>Encontre as melhores para você</strong><small>Conte seus interesses e receba uma seleção feita para o seu momento.</small></div><button onClick={start}>Descobrir as minhas <b>&gt;</b></button></Reveal>
    </div></section>
